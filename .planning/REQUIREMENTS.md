...
- [ ] **CARD-01**: Afficher 7 emotions desagreables en grille
- [ ] **CARD-02**: Afficher 6 sentiments agreables en grille
- [ ] **CARD-03**: Fond colore plein par emotion (couleur distinctive)
- [ ] **CARD-04**: Icone Lucide + 3 mots-cles sur carte fermee
...
- [ ] **PANEL-04**: Culpabilite: 2 niveaux (4 sous-cartes -> detail)
...
- [ ] **ANIM-01**: Hover: elevation legere + box-shadow
- [ ] **ANIM-02**: Transitions 200ms sur changements d'etat
